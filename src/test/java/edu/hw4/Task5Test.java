...
public class Task5Test {
    ...
    public void testMoreM() {
        ...
        assertThat(Task5.countAnimalsBySex(animals)).isEqualTo(Animal.Sex.M);
    }

    @Test
    public void testMoreF() {
        Animal lion = new Animal("Lion", Animal.Type.CAT, Animal.Sex.M, 2, 120, 55, true);
        Animal elephant = new Animal("Elephant", Animal.Type.BIRD, Animal.Sex.F, 3, 300, 150, false);
        Animal giraffe = new Animal("Giraffe", Animal.Type.BIRD, Animal.Sex.F, 4, 540, 300, false);
        Animal zebra = new Animal("Zebra", Animal.Type.FISH, Animal.Sex.F, 5, 150, 200, false);

        List<Animal> animals = Arrays.asList(elephant, zebra, lion, giraffe);

        assertThat(Task5.countAnimalsBySex(animals)).isEqualTo(Animal.Sex.F);
    }
    ...
    public void testEqual() {
        ...
        assertThat(Task5.countAnimalsBySex(animals)).isNull();
    }
